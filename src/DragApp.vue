<template>
  <div class="main">
    ...
    <div v-for="boxNumber in boxes" :key="boxNumber" v-draggable class="draggable-container">
      Simple Draggable
    </div>

    <div v-draggable="draggableWithHandler" class="draggable-with-handler">
    ...
    <div ref="bounder" class="container-for-draggable">
      <div v-draggable="draggableWithBoundries" class="draggable-container">
        drag me within my boundries
      </div>
    </div>

    <div v-draggable="draggableWithResetPosition" class="draggable-with-reset" @dblclick="onReset">
...
<script>
  ...
  function getDragCallback(name) {
    function dragCallback(positionDiff, absolutePosition, event = {}) {
      // eslint-disable-next-line no-console
      console.log(name, absolutePosition, positionDiff, {clientX: event.clientX, clientY: event.clientY})
    }
  ...
  export default {
    ...
    data() {
      return {
        ...
        draggableWithHandler: {
          handle: undefined,
          onPositionChange: getDragCallback('onPositionChange'),
          onDragStart: getDragCallback('onDragStart'),
          onDragEnd: getDragCallback('onDragEnd'),
        },
